...
final List<MenuGroupModel> menuGroups = [
  MenuGroupModel(title: "Milk & Dahi", items: [
    ...
    MenuItemModel(name: 'Curd', price: '₹180', img: 'assets/Curd-with-ghee.jpg', extras: ['250g', '500g', '1kg']),
  ...
  MenuGroupModel(title: "Ghee", items: [
    ...
    MenuItemModel(name: "Buffalo Ghee", price: "₹900", img: "assets/buffalo-ghee.jpg", extras: ["250g", "500g", "1kg"]),
  ]),
  MenuGroupModel(title: "Butter", items: [
    MenuItemModel(name: 'Cow Butter', price: '₹800', img: 'assets/cow-butter.jpg', extras: ['250g', '500g', '1kg']),
    MenuItemModel(name: 'Buffalo Butter', price: '₹800', img: 'assets/buffalo-butter.webp', extras: ['250g', '500g', '1kg']),
  ]),
  ...
  MenuGroupModel(title: "Sweets (Mithai)", items: [
    ...
    MenuItemModel(name: "Khawa", price: "₹440", img: "assets/khava.webp", extras: ["250g", "500g", "1kg"]),
  ...
  MenuGroupModel(title: "Brand - English Oven", items: [
    MenuItemModel(name: "Garlic Bread", price: "₹35", img: "assets/garlic bread.webp", extras: ["200gm"]),
    MenuItemModel(name: "MultiGrain Zero Maida", price: "₹65", img: "assets/MultiGrain Zero Maida.jpg", extras: ["400gm"]),
    MenuItemModel(name: "Sandwich Bread", price: "₹45", img: "assets/Sandwich Bread.webp", extras: ["400gm"]),
    MenuItemModel(name: "Whole Wheat Bread No Maida", price: "₹60", img: "assets/Whole Wheat Bread No Maida.webp", extras: ["400gm"]),
    ...
    MenuItemModel(name: "White Bread", price: "₹65", img: "assets/White Bread.webp", extras: ["600gm"]),
    MenuItemModel(name: "Nutrilay Fresh Egg", price: "₹60", img: "assets/Nutrilay Fresh Egg.webp", extras: ["6 pcs"]),
  ]),
  ...
  MenuGroupModel(title: "Brand - Malpanis (Bake Lite) Bakery", items: [
    ...
    MenuItemModel(name: "Twisted Khari", price: "₹90", img: "assets/Twisted Khari.webp", extras: ["200gm"]),
    MenuItemModel(name: "Tuti Fruti Toast", price: "₹52", img: "assets/Tuti Fruti Toast.jpg", extras: ["150gm"]),
    MenuItemModel(name: "Brown Toast No Added Sugar", price: "₹62", img: "assets/Brown Toast No Added Sugar.webp", extras: ["150gm"]),
    MenuItemModel(name: "Milk Toast", price: "₹68", img: "assets/Milk Toast.jpg", extras: ["200gm"]),
    MenuItemModel(name: "Brown Toast", price: "₹75", img: "assets/Brown Toast.webp", extras: ["200gm"]),
    ...
    MenuItemModel(name: "Namkeen Mathri", price: "₹75", img: "assets/Namkeen Mathri.webp", extras: ["200gm"]),
  ...
  MenuGroupModel(title: "Brand - Katdare (कटधरे मसाले)", items: [
    MenuItemModel(name: "Mango Pickle", price: "₹68", img: "assets/Mango Pickle.webp", extras: ["Standard"]),
    MenuItemModel(name: "Green Chilli Pickle", price: "₹68", img: "assets/Green Chilli Pickle.webp", extras: ["Standard"]),
    MenuItemModel(name: "Lemon Pickle", price: "₹68", img: "assets/Lemon Pickle.webp", extras: ["Standard"]),
    MenuItemModel(name: "Mix Pickle", price: "₹68", img: "assets/Mix Pickle.jpg", extras: ["Standard"]),
    MenuItemModel(name: "Sweet Lemon", price: "₹68", img: "assets/Sweet Lemon.webp", extras: ["Standard"]),
    MenuItemModel(name: "Shengdana Chatni", price: "₹50", img: "assets/Shengdana Chatni.webp", extras: ["Standard"]),
    ...
    MenuItemModel(name: "Lasoon Chatni", price: "₹65", img: "assets/Lasoon Chatni.webp", extras: ["Standard"]),
  ]),
  MenuGroupModel(title: "Brand - Suhana", items: [
    MenuItemModel(name: "paneer Tikka masala", price: "₹50", img: "assets/paneer Tikka masala.webp", extras: ["50gm"]),
